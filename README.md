...
* [`src/caiu/`](src/caiu/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/caiu/core.cljs): contains the SPA entry point, `init`
...
5. Clone this repo and open a terminal in the `caiu` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/caiu/config.cljs) defaults to `true` in
